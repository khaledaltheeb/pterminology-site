...
def main() -> None:
    ...
    blog_card = '<article class="card"><h3>المدونة التحليلية</h3><p>مقالات ركيزية تشرح الفروق النفسية والأسئلة اليومية بمصادر واضحة وروابط إلى الموسوعة والأدوات.</p><a href="blog/">قراءة مقالات المدونة</a></article>'
