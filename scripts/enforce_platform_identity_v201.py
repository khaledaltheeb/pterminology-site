...
REPLACEMENTS = (
    ...
    (re.compile(r"(?<![\w\u0600-\u06ff])المعاقة(?![\w\u0600-\u06ff])"), "شخص من ذوي الاحتياجات الخاصة"),
    (re.compile(r"(?<![\w\u0600-\u06ff])معاقة(?![\w\u0600-\u06ff])"), "شخص من ذوي الاحتياجات الخاصة"),
    (re.compile(r"(?<![\w\u0600-\u06ff])المعاق(?![\w\u0600-\u06ff])"), "الشخص ذو الاحتياجات الخاصة"),
    (re.compile(r"(?<![\w\u0600-\u06ff])معاق(?![\w\u0600-\u06ff])"), "شخص ذو احتياجات خاصة"),
)
BANNED_RE = re.compile(
    r"(?<![\w\u0600-\u06ff])(?:المعاقين|معاقين|المعاقون|معاقون|المعاقة|معاقة|المعاق|معاق)(?![\w\u0600-\u06ff])"
)
