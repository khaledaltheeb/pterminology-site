...
SECTION_LABELS = {
    ...
    "transition_protocol": "بروتوكول الانتقالات والتغييرات",
    "meltdown_protocol": "بروتوكول الانهيار أو التصعيد",
    "emotion_protocol": "بروتوكول الانفعال والتصعيد",
    "wandering_protocol": "بروتوكول الهروب أو الضياع",
    "sleep_plan": "خطة النوم",
    "food_plan": "خطة صعوبات الطعام",
...
HOWTO_KEYS = (
    "do", "conversation_steps", "plan", "caregiver_plan", "home_plan",
    "school_plan", "communication_plan", "sensory_plan",
    "transition_protocol", "meltdown_protocol", "wandering_protocol",
)
...
def index_page(data: dict) -> str:
    ...
    description = "أدلة عربية عملية موثقة لدعم الأسرة والأصدقاء ومقدمي الرعاية، تشمل ADHD والتوحد وإجهاد مقدم الرعاية."
...
def main() -> None:
    ...
    autism = next(g for g in guides if g["slug"] == "autism-family-practical-guide")
    report = {
        "version": 39,
        "guides": len(guides),
