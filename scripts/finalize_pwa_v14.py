...
SERVICE_WORKER = r'''/* pterminology v14 performance service worker */
...
def main() -> None:
    ...
    report = {
        "version": 14,
        "cache_name": "pterminology-v14-performance",
    ...
    if not all(report[key] for key in ("skip_waiting", "clients_claim", "old_cache_deleted", "network_first_scripts")):
