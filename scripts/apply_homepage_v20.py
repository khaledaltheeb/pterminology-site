...
def main() -> None:
    ...
    report = {
        ...
        "institutional_foundation_publisher": 192,
        "institutional_foundation_sitemap_sync": 194,
    }
    ...
    run_publisher("publish_institutional_foundation_v192.py")
    register_sitemap("sitemap-institutional-foundation.xml")
