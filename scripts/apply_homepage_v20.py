...
def main() -> None:
    ...
    report = {
        ...
        "evaluate_information_publisher": 181,
        "evaluate_information_sitemap_sync": 182,
    }
    ...
    run_publisher("publish_evaluate_mental_health_information_v181.py")
    register_sitemap("sitemap-evaluate-mental-health-information.xml")
